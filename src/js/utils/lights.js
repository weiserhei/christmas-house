...
export default function x(scene) {
  var hemiLight = new HemisphereLight(0xffffff, 0xffffff, 1.8);
  hemiLight.color.setHSL(0.6, 0, 1);
  hemiLight.groundColor.setHSL(0.095, 0, 1);
  hemiLight.position.set(0, 5, 0);
  scene.add(hemiLight);
  var dirLight = new DirectionalLight(0xffffff, 2);
  ...
  var pointLight = new PointLight(0xffff55, 1);
